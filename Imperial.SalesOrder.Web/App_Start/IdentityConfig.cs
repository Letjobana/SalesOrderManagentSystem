...
using Imperial.SalesOrder.Identity;
...
namespace Imperial.SalesOrder.Web
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            SmtpClient smtpClient = new SmtpClient(ConfigurationManager.AppSettings["SMTP_Host"]);
            MailMessage mailMessage = new MailMessage();

            mailMessage.To.Add(message.Destination);
            mailMessage.Subject = message.Subject;
            mailMessage.Body = message.Body;
            mailMessage.From = new MailAddress(ConfigurationManager.AppSettings["SMTP_From"]);
    ...
    public class ApplicationUserManager : UserManager<IdentityUser, int>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore(context.Get<Repository>()));
